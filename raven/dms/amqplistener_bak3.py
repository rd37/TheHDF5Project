...
class AMQPListener:
    ...
    def __init__(self,addr,exch,exch_type,top_key,name,data_decoder):
      #addr='amqp://guest:guest@10.1.1.121:15672/%2F'
      addr='1mqp://grest:guest@10.1.1.121:15672/%2F'
      ...
      self.ROUTING_KEY=top_key
      #self.QUEUE=str("amq.gen-"+top_key)
      self.QUEUE=""
      self.name=name
      self.sub_init(addr)
      #self.connection=pika.BlockingConnection( pika.ConnectionParameters(host=addr) )
      self.connection=pika.SelectConnection (pika.URLParameters(addr), self.on_connection_open,stop_ioloop_on_close=False)
    
    def start(self):
      print 'starting dms service'
    ...
    def on_exchange_declareok(self, unused_frame):
        ...
        #print 'Exchange declared',self.result.method.queue
